...
For a user task \(\tau\), the user’s task instruction at step \(t\) can be represented as \(I^{U}_{\tau,t} = I^{E}_{\tau,t} \cup I^{I}_{\tau,t} = \{i_1, i_2, \ldots, i_{n_t}\}\), where each \(i_j\) is a unit instruction, \(I^{E}_{\tau,t}\) 
