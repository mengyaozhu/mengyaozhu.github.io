...
\longrightarrow
\begin{cases}
\text{Successful} \longrightarrow \boxed{\text{Expected Result}} \\[6pt]
\text{Unsuccessful} \longrightarrow \boxed{\text{Fallback Instructions}}
\longrightarrow \boxed{\text{Alternative Execution}}
\longrightarrow \boxed{\text{Expected Result}}
\end{cases}
$$
